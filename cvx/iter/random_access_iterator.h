// clang-format off
#ifndef V
#error "cvx/iter/random_access_iterator.h requires V to be defined (the element type, e.g. #define V int)"
#endif
#ifndef INTERFACE
#error "cvx/iter/random_access_iterator.h requires INTERFACE to be defined (the struct name, e.g. #define INTERFACE my_iter)"
#endif
// clang-format on
