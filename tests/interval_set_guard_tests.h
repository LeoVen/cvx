...
static void test_is_int_guard_clone(struct cvxtest *t)
{
    ...
    cvx_container *res = is_int_clone(col);
    CVXCHECK(t, res == NULL);
...
{
    MAKE_INVALID_CONTAINER(col);
    bool res = is_int_contains(col, 3);
    CVXCHECK(t, res == false);
    CVXCHECK(t, col->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(col);
    bool res = is_int_contains_interval(col, 1, 5);
    CVXCHECK(t, res == false);
    CVXCHECK(t, col->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(col);
    bool res = is_int_overlaps(col, 1, 5);
    CVXCHECK(t, res == false);
    CVXCHECK(t, col->flag == CVX_FLAG_WRONG_TAG);
}
...
static void test_is_int_guard_iter_init_start(struct cvxtest *t)
{
    MAKE_INVALID_CONTAINER(col);
...
static void test_is_int_guard_iter_init_end(struct cvxtest *t)
{
    MAKE_INVALID_CONTAINER(col);
...
{
    MAKE_INVALID_CONTAINER(iter);
    bool res = is_int_iter_at_start(iter);
    CVXCHECK(t, res == false);
    CVXCHECK(t, iter->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(iter);
    bool res = is_int_iter_at_end(iter);
    CVXCHECK(t, res == false);
    CVXCHECK(t, iter->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(iter);
    size_t res = is_int_iter_count(iter);
    CVXCHECK(t, res == 0);
    CVXCHECK(t, iter->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(iter);
    struct iset_int_entry res = is_int_iter_value(iter);
...
{
    MAKE_INVALID_CONTAINER(iter);
    int res = is_int_iter_value_lo(iter);
    CVXCHECK(t, res == 0);
    CVXCHECK(t, iter->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(iter);
    int res = is_int_iter_value_hi(iter);
    CVXCHECK(t, res == 0);
    CVXCHECK(t, iter->flag == CVX_FLAG_WRONG_TAG);
}
...
{
    MAKE_INVALID_CONTAINER(iter);
    size_t res = is_int_iter_index(iter);
    CVXCHECK(t, res == 0);
    CVXCHECK(t, iter->flag == CVX_FLAG_WRONG_TAG);
}
...
static int run_interval_set_guard_tests(void)
{
    ...
    CVXRUN(&t, test_is_int_guard_iter_init_start);
    CVXRUN(&t, test_is_int_guard_iter_init_end);
